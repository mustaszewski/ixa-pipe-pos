...
public class CRFTrainer extends AbstractSequenceTrainer {
	// extends abstractsequencetrainer
  ...
  public SequenceClassificationModel<String> doTrain(SequenceStream sequences)
    ...
    while ((sequence = sequences.read()) != null) {
      ...
      for (int eventIndex = 0; eventIndex < events.length; eventIndex++) {
        ...
        // START DEBUG ONLY
    	try {
    		FileWriter writer = new FileWriter("CRFTrainer.txt", true);
      ...
      //System.out.println("############################" +trainingData.getPipe().instanceFrom(inst));
    ...
    */
    ...
    //CRFTrainerByThreadedLabelLikelihood crfTrainer = new CRFTrainerByThreadedLabelLikelihood(crf, 2);
...
//     crfTrainer.setMaxResets(0);
    ...
    crfTrainer.train(trainingData, 100);
